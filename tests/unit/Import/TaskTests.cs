...
namespace Dime.Scheduler.Tests.Import
{
    public partial class TaskTests
    {
        ...
        [Fact]
        public void Task_ToImportRequest_Delete_AllShouldMapParameters()
        {
            Task model = new()
            {
                SourceApp = "APP",
        ...
        [Fact]
        public void Task_ToImportRequest_InvalidTransactionType_ShouldThrowArgumentOutOfRangeException()
            => ToImportRequestTestUtils.TestToInvalidImportRequest<Task>();
    }
}